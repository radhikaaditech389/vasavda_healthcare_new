                    ...
                    <div class="card patients-list">
                        <div class="body">
                            <div class="table-responsive">
                                <table id="doctorsTable" class="table m-b-0 table-hover">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Name</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-round edit-doctor"
                                                        ...
                                                        data-specialization="{{ $doctor->specialization }}">Edit</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#doctorForm').on('submit', function(e) {
                ...
                const url = doctorId ? '{{ route('admin.doctors.update', ['id' => ':id']) }}'.replace(
                    ':id', doctorId) : '{{ route('admin.doctors.store') }}';
                const method = doctorId ? 'POST' : 'POST';
