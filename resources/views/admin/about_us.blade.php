                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{ route('admin.about_us.update') }}" method="POST"
                                ...
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="aboutUs_id" id="aboutUs_id" value="{{ $about->id ?? '' }}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="sub_title" id="sub_title"
                                                placeholder="Enter subtitle" value="{{ $about->sub_title ?? '' }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="modern-upload-wrapper" id="modern-upload-area1">
                                                ...
                                                <div class="modern-upload-preview" id="current_image1"
                                                    style="display: {{ !empty($about->image) ? 'block' : 'none' }};">
                                                    @if (!empty($about->image))
                                                        <img src="{{ asset($about->image) }}" alt="Image 1"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <textarea class="form-control summernote" name="sub_description"
                                                id="sub_description"
                                                placeholder="Enter extra details">{{ $about->sub_description ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
