                            ...
                            <form action="{{ route('admin.facilities.store') }}" method="POST"
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="description" id="description" placeholder="Enter description" rows="2"
                                    ...
                                    <tbody>
                                        @foreach ($facilities as $facility)
                                            <tr data-id="{{ $facility->id }}">
                                                ...
                                                <td>
                                                    <button type="button"
                                                        class="btn btn-primary btn-round edit-facility"
                                                        data-id="{{ $facility->id }}"
