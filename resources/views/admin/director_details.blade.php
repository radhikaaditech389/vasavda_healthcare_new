...
<body class="theme-cyan">
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Edit Director Details</strong></h2>
                        </div>
                        <div class="body">
                            <form action="{{ route('admin.director_details.update', $director_data->id) }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="specialization"
                                                value="{{ $director_data->specialization }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-desc"
                                                name="skills">{{ $director_data->skills }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control summernote"
                                                name="bio">{{ $director_data->bio }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="row clearfix">
                                    <div class="col-sm-6">
                                        ...
                                        @if($director_data->image)
                                        <img src="{{ asset($director_data->image) }}" alt="Director Image"
                                ...
                                <div class="modern-upload-wrapper" id="modern-upload-area1">
                                    ...
                                    <div class="modern-upload-preview" id="current_image1"
                                        style="display: {{ !empty($director_data->image) ? 'block' : 'none' }};">
                                        @if (!empty($director_data->image))
                                        <img src="{{ asset($director_data->image) }}" alt="Image 1"
                                ...
                                <div id="campaigns-wrapper">
                                    @if($director_data->campaigns)
                                    @foreach(json_decode($director_data->campaigns, true) as $index => $campaign)
                                    <div class="campaign-item mb-3 d-flex">
                                        <input type="text" name="campaigns[{{ $index }}][title]"
                                            class="form-control mb-2 text-content" placeholder="Campaign Title"
                                            value="{{ $campaign['title'] ?? '' }}">
                                        <textarea name="campaigns[{{ $index }}][desc]" class="form-control form-content"
                                            placeholder="Campaign Description">{{ $campaign['desc'] ?? '' }}</textarea>
                                        <button type="button"
                                            class="btn btn-danger btn-sm remove-campaign">Remove</button>
                                    </div>
                                    @endforeach
                                    @endif
                                </div>
                                <button type="button" class="btn btn-sm btn-success campaign-btn">+ Add
                                    Campaign</button>
                                <hr>
                                ...
                                <!-- <div class="row clearfix">
                                    <div class="col-sm-6">
                                        ...
                                        @if($director_data->campaign_image)
                                        <img src="{{ asset($director_data->campaign_image) }}"
                                 ...
                                 <div class="modern-upload-wrapper" id="modern-upload-area1">
                                    ...
                                    <input type="file" class="modern-upload-input" name="campaign_image" id="image2"
                                        accept="image/*">
                                    <button type="button" class="modern-upload-btn"
                                    ...
                                    <div class="modern-upload-preview" id="current_image2"
                                        style="display: {{ !empty($director_data->campaign_image) ? 'block' : 'none' }};">
                                        @if (!empty($director_data->campaign_image))
                                            <img src="{{ asset($director_data->campaign_image) }}" alt="Image 1"
                                                style="max-width: 120px; max-height: 120px;">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div id="trainings-wrapper">
                                    @if($director_data->trainings)
                                    @foreach(json_decode($director_data->trainings, true) as $index => $training)
                                ...
                                <!-- <div class="row clearfix">
                                    <div class="col-sm-6">
                                        ...
                                        @if($director_data->training_image)
                                        <img src="{{ asset($director_data->training_image) }}" alt="Training Image"
                                            style="max-width: 120px; margin-top: 10px;">
                                        @endif
                                    </div>
                                </div> -->
                                 ...
                                 <div class="modern-upload-wrapper" id="modern-upload-area1">
                                    ...
                                    <input type="file" class="modern-upload-input" name="training_image" id="image4"
                                        accept="image/*">
                                    <button type="button" class="modern-upload-btn"
                                    ...
                                    <div class="modern-upload-preview" id="current_image4"
                                        style="display: {{ !empty($director_data->training_image) ? 'block' : 'none' }};">
                                        @if (!empty($director_data->training_image))
                                            <img src="{{ asset($director_data->training_image) }}" alt="Image 1"
                                                style="max-width: 120px; max-height: 120px;">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div id="conferences-wrapper">
                                    @if($director_data->conferences)
                                    @foreach(json_decode($director_data->conferences, true) as $index => $conference)
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-desc"
                                                name="media_presence">{{ $director_data->media_presence }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="row clearfix">
                                    <div class="col-sm-6">
                                        ...
                                        @if($director_data->award_image)
                                        <img src="{{ asset($director_data->award_image) }}" alt="Award Image"
                                            style="max-width: 120px; margin-top: 10px;">
                                        @endif
                                    </div>
                                </div> -->
                                ...
                                <div class="modern-upload-wrapper" id="modern-upload-area1">
                                    ...
                                    <input type="file" class="modern-upload-input" name="award_image" id="image3"
                                        accept="image/*">
                                    <button type="button" class="modern-upload-btn"
                                    ...
                                    <div class="modern-upload-preview" id="current_image3"
                                        style="display: {{ !empty($director_data->award_image) ? 'block' : 'none' }};">
                                        @if (!empty($director_data->award_image))
                                            <img src="{{ asset($director_data->award_image) }}" alt="Image 1"
                                                style="max-width: 120px; max-height: 120px;">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div id="awards-wrapper">
                                    @if($director_data->awards)
                                    @foreach(json_decode($director_data->awards, true) as $index => $award)
                                    <div class="award-item mb-3 d-flex">
                                        <input type="text" name="awards[{{ $index }}][title]"
                                            class="form-control mb-2 text-content" placeholder="Training Title"
                                            value="{{ $award['title'] ?? '' }}">
                                        <textarea name="awards[{{ $index }}][desc]" class="form-control form-content"
                                            placeholder="award Description">{{ $award['desc'] ?? '' }}</textarea>
                                        <button type="button" class="btn btn-danger btn-sm remove-award">Remove</button>
                                    </div>
                                    @endforeach
                                    @endif
                                </div>
                                <button type="button" class="btn btn-sm btn-success" onclick="addAwards()">+ Add
                                    awards</button>
                                <hr>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-desc"
                                                name="community_charity_work">{{ $director_data->community_charity_work }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="row clearfix">
                                    <div class="col-sm-6">
                                        ...
                                        @if($director_data->charity_image)
                                        <img src="{{ asset($director_data->charity_image) }}" alt="Award Image"
                                            style="max-width: 120px; margin-top: 10px;">
                                        @endif
                                    </div>
                                </div> -->
                                <div class="modern-upload-wrapper" id="modern-upload-area1">
                                    ...
                                    <div class="modern-upload-preview" id="current_image5"
                                        style="display: {{ !empty($director_data->charity_image) ? 'block' : 'none' }};">
                                        @if (!empty($director_data->charity_image))
                                            <img src="{{ asset($director_data->charity_image) }}" alt="Image 1"
                                                style="max-width: 120px; max-height: 120px;">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div id="memberships-wrapper">
                                    @if($director_data->memberships)
                                    @foreach(json_decode($director_data->memberships, true) as $index => $membership)
                                ...
                                <!-- <div class="row clearfix">
                                    <div class="col-sm-6">
                                        ...
                                        @if($director_data->membership_image)
                                        <img src="{{ asset($director_data->membership_image) }}" alt="Award Image"
                                            style="max-width: 120px; margin-top: 10px;">
                                        @endif
                                    </div>
                                </div> -->
                                <div class="modern-upload-wrapper" id="modern-upload-area1">
                                    ...
                                    <div class="modern-upload-preview" id="current_image6"
                                        style="display: {{ !empty($director_data->membership_image) ? 'block' : 'none' }};">
                                        @if (!empty($director_data->membership_image))
                                            <img src="{{ asset($director_data->membership_image) }}" alt="Image 1"
                                                style="max-width: 120px; max-height: 120px;">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div id="publications_talks-wrapper">
                                    @if($director_data->publications_talks)
                                    @foreach(json_decode($director_data->publications_talks, true) as $index =>
                                    $publications_talk)
    ...
    let campaignIndex = {{ $director_data->campaigns ? count(json_decode($director_data->campaigns, true)) : 0 }};
    let trainingIndex = {{ $director_data->trainings ? count(json_decode($director_data->trainings, true)) : 0 }};
    let conferenceIndex = {{ $director_data->conferences ? count(json_decode($director_data->conferences, true)) : 0 }};
    let awardIndex = {{ $director_data->awards ? count(json_decode($director_data->awards, true)) : 0 }};
    let membershipIndex = {{ $director_data->memberships ? count(json_decode($director_data->memberships, true)) : 0 }};
    let publicationsTalkIndex = {{ $director_data->publications_talks ? count(json_decode($director_data->publications_talks, true)) : 0 }};


    $(".campaign-btn").click(function() {
        let wrapper = document.getElementById('campaigns-wrapper');
