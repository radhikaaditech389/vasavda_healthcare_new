...
<head>
    ...
    <title>Interfertility - Vasavada womens hospital Bopal</title>
    <meta name="author" content="Vasavada Women's Hospital">
    <meta name="description" content="Interfertility at top womens hospital bopal and lady gynecologist bopal">
    <meta name="keywords"
        content="Interfertility bopal, Womens hospital bopal, Women's hospital bopal, gynecologist bopal, lady gynecologist bopal, womens hospital near by, gynecologist near by, lady gynecologist near by">
    <link rel="canonical" href="https://www.vasavadahospitals.org/interfertility" />
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="vs-accordion accordion accordion-style2"
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">Process</h2>
                                <p>{!! $service->services_html !!}</p>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header">Complication</h2>
