...
<body class="">
    ...
    -webkit-text-fill-color: white; ">Speical Clinics</h1>
                <div class="breadcumb-menu-wrap">
                    <i class="far fa-home-lg"></i>
                    <ul class="breadcumb-menu">
                        <li><a href="/">Home</a></li>
                        <li class="active">Speical Clinics</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section id="pregnancy-section" class="vs-accordion-wrapper space-top space-md-bottom">
        <div class="container">
            <div class="title-area-four text-center  wow fadeInUp" data-wow-delay="400ms">
                <span class="sub-title8"><h2>Paediatric Clinic
</h2></span>
            </div>
            <div class="row">
                <div class="col-xl-6">
                    ...
                    <br>
                    <img src="{{ asset('patient/img/service/sr-d-2.jpg') }}" alt="Service Image" style="width: 550px; height: 300px;">
                </div>
                <div class="col-xl-6">
                    <div class="vs-accordion accordion accordion-style2" id="vsaccordion">
