...
<body class="">
    ...
    -webkit-text-fill-color: #702840; ">Pregnancy Care & Delivery</h1>
                <div class="breadcumb-menu-wrap">
                    <i class="far fa-home-lg"></i>
                    <ul class="breadcumb-menu">
                        <li><a href="/">Home</a></li>
                        <li class="active">Pregnancy Care & Delivery</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12">
                        <div class="service-tabs">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                <button class="nav-link" id="naturalbirthing-tab" data-bs-toggle="tab" data-bs-target="#naturalbirthing" type="button" role="tab" aria-controls="naturalbirthing" aria-selected="false"><i class="fa fa-plus"></i>Natural Birthing</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="doulabirth-tab" data-bs-toggle="tab" data-bs-target="#doulabirth" type="button" role="tab" aria-controls="doulabirth" aria-selected="false"><i class="fa fa-plus"></i>Doula Birth</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="csections-tab" data-bs-toggle="tab" data-bs-target="#csections" type="button" role="tab" aria-controls="csections" aria-selected="false"><i class="fa fa-plus"></i>C-sections</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-pane fade" id="doulabirth" role="tabpanel" aria-labelledby="doulabirth-tab">
                                <div class="service-tab-content">
                                    ...
                                    <ul class="ser-list-nine">
                                        ...
                                        <li>Enhanced comfort through pain management techniques.</li>
                                        <li>Support during the postpartum period.</li>
                                    </ul>
    ...
    {{-- Highrisk Pregnancy section start --}}
                ...
                <div class="col-lg-5 col-md-12 col-sm-12">
                    <div class="about-content-eight">
                        ...
                        <p>
                            ...
                            and our dedicated team is here to provide guidance and support every step of the way.
                        </p><br>
    ...
    {{-- Highrisk Pregnancy Section ends --}}
