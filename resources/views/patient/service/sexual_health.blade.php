...
<head>
    ...
    <meta name="keywords"
        content="Sexual Health bopal, Womens hospital bopal, Women's hospital bopal, gynecologist bopal, lady gynecologist bopal, womens hospital near by, gynecologist near by, lady gynecologist near by">
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="vs-accordion accordion accordion-style2" id="vsaccordion-left-{{ $service->id }}">
                            <div class="accordion-item">
                                <h2 class="accordion-header">Overview</h2>
                                <p>{!! $service->purpose_html !!}</p>
                            </div>
                            @if (!empty($service->considerations_html))
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        {{ $service->title === 'Sexual Health Counseling' ? 'Focus Areas' : 'Symptoms' }}
                                    </h2>
                    ...
                    <div class="col-xl-6">
                        <div class="vs-accordion accordion accordion-style2"
                            ...
                            @if (!empty($service->services_html))
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        {{ $service->title === 'Dilatation' || 'Botox Surgery for Vaginal Conditions' ? 'Procedure' : 'Treatment' }}
                                    </h2>
