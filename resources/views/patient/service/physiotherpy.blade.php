...
<head>
    ...
    <title>Physiotherapy and Antenatal (ANC) Classes - Vasavada womens hospital Bopal</title>
    <meta name="author" content="Vasavada Women's Hospital">
    <meta name="description"
        content="Physiotherapy and Antenatal (ANC) Classes at top womens hospital bopal and lady gynecologist bopal">
    <meta name="keywords"
        content="Physiotherapy and Antenatal Classes bopal, Womens hospital bopal, Women's hospital bopal, gynecologist bopal, lady gynecologist bopal, womens hospital near by, gynecologist near by, lady gynecologist near by">
    <link rel="canonical" href="https://www.vasavadahospitals.org/physiotherapy" />
        ...
        <div class="service-section-nine">
            <div class="container-style8">
                <div class="title-area-four text-center wow fadeInUp" data-wow-delay="400ms">
                    <h5 style="text-transform: uppercase; color: #e91e63 !important;">Key Types of physiotherapy</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="vs-accordion accordion accordion-style2"
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">Focus Areas</h2>
