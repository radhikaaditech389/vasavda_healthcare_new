...
<head>
    ...
    <meta name="keywords" content="Contact Womens hospital bopal, Women's hospital bopal, gynecologist bopal, lady gynecologist bopal, womens hospital near by, gynecologist near by, lady gynecologist near by">
        ...
        <div class="container">
            <div class="row gx-60 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="ajax-contact form-wrap3 mb-30" data-bg-color="#f3f6f7">
                        @csrf
                    ...
                    @endif
                        <div class="form-title">
                            ...
                            <p class="text-theme mb-4" style="color:#000 !important;">Your email address will not be published *</p>
                        </div>
                        ...
                        <div class="form-group mb-15">
                            <input type="phone" name="phone" id="phone" class="form-control style3" placeholder="Phone"></input>
                    ...
                    <div class="contact-information mb-30">
                        ...
                        <div class="row">
                            <div class="col-xxl-10">
                                <p>At Vasavada Healthcare, we are dedicated to providing compassionate, personalized care for women at every stage of life. Whether you need a routine checkup, specialized treatment, or advice, our expert team is here to guide you every step of the way.
</p>
                            </div>
                        </div>
                        ...
                        <table class="contact-info-table">
                            ...
                            <tr>
                                ...
                                <td>10:00 AM - 01:00 PM & 04:00 PM - 08:00 PM
                            </tr>
                        </table>
                        <h5 class="pt-2 mb-10">Address</h5>
                        <p class="fs-md"><i class="far fa-map-marker-alt me-2"></i>4th / 5th Floor, Sun South Trade Center,
...
{{-- <p class="fs-md"><i class="far fa-map-marker-alt me-2"></i>A-308, Maple Trade Centre, Surdhara Cir, nr. Sal Hospital Road, Thaltej, Ahmedabad, Gujarat 380052.</p> --}}
                        ...
                        <h5 class="h5 font-theme2 mb-0"><a href="tel:880369525423"><i class="far fa-phone-alt me-2"></i>+91 98790 09439</a></h5>
                        </div>
                </div>
            </div>
            <div class="ratio ratio-21x9 contact-map mt-70 mb-30">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.997573790188!2d72.46589959678953!3d23.0238613!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e9ba2222d106b%3A0x3e2bf5885a0a5fe0!2sVasavada%20Womens%20hospital!5e0!3m2!1sen!2sin!4v1733126859163!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
    </section>
    <!--==============================
